...
func registerAdminSystemRoutes(router *gin.Engine, h *Handler, deps RouterDeps) {
	...
	adminSystem.Use(middleware.AuditMiddleware(auditService))
	{
		...
		adminSystem.GET("/email/providers", h.EmailProviderCatalog)
		adminSystem.GET("/email/configs", h.AdminPlatformEmailConfigList)
		adminSystem.POST("/email/configs", h.AdminPlatformEmailConfigCreate)
		adminSystem.GET("/email/channel", h.AdminPlatformEmailChannel)
		adminSystem.GET("/email/deliveries", h.AdminPlatformEmailDeliveryList)
		adminSystem.GET("/email/stats", h.AdminPlatformEmailDeliveryStats)
		adminSystem.GET("/email/configs/:configId", h.AdminPlatformEmailConfigDetail)
		adminSystem.PUT("/email/configs/:configId", h.AdminPlatformEmailConfigUpdate)
		adminSystem.DELETE("/email/configs/:configId", h.AdminPlatformEmailConfigDelete)
		adminSystem.POST("/email/configs/:configId/test", h.AdminPlatformEmailConfigTest)
		// 平台级 AI 通道 / 技能 / MCP：与邮件通道同一套作用域戒律 ——
		// 平台级恒用 aidomain.PlatformAppID，不接受请求体里的 appid。
		adminSystem.GET("/ai/providers", h.AIProviderCatalog)
		adminSystem.GET("/ai/configs", h.AdminPlatformAIConfigList)
		adminSystem.POST("/ai/configs", h.AdminPlatformAIConfigCreate)
		adminSystem.GET("/ai/channel", h.AdminPlatformAIChannel)
		adminSystem.PUT("/ai/configs/:configId", h.AdminPlatformAIConfigUpdate)
		adminSystem.DELETE("/ai/configs/:configId", h.AdminPlatformAIConfigDelete)
		adminSystem.POST("/ai/configs/:configId/test", h.AdminPlatformAIConfigTest)
		adminSystem.GET("/ai/skills", h.AdminPlatformAISkillList)
		adminSystem.POST("/ai/skills", h.AdminPlatformAISkillCreate)
		adminSystem.PUT("/ai/skills/:skillId", h.AdminPlatformAISkillUpdate)
		adminSystem.DELETE("/ai/skills/:skillId", h.AdminPlatformAISkillDelete)
		adminSystem.GET("/ai/mcp-servers", h.AdminPlatformAIMCPList)
		adminSystem.POST("/ai/mcp-servers", h.AdminPlatformAIMCPCreate)
		adminSystem.PUT("/ai/mcp-servers/:serverId", h.AdminPlatformAIMCPUpdate)
		adminSystem.DELETE("/ai/mcp-servers/:serverId", h.AdminPlatformAIMCPDelete)
		adminSystem.POST("/ai/mcp-servers/:serverId/test", h.AdminPlatformAIMCPTest)
